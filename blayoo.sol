...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd4C06F6595ca1b67a92de7672340cCe99FEE50De;
...
contract Blayoo is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x2Ee2Dca1Eb5D7Ed2f7CF433d0B5777C03816d9aA;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 50000 * 10**3 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Blayoo";
    string private _symbol = "BLAY";
    ...
    uint256 private numTokensSellToAddToLiquidity = 500 * 10**3 * 10**8;
    ...
    function setSellFee(uint256 sellTaxFee, uint256 sellMarketingFee) external onlyOwner {
